...
class VerificationNet(nn.Module):
    def __init__(
        ...
        self.opt = optim.Adam(self.parameters(), lr=VERIF_NET_LEARNING_RATE)
    ...
    def train(self, trainset: StackedMNIST, valset: StackedMNIST, epochs: int = VERIF_NET_EPOCHS, batch_size: int = VERIF_NET_BATCH_SIZE) -> bool:
        """
